...
public class ResponseSpec {
    ...
    public static String errorDepositCannotExceed_5000 = "Deposit amount exceeds the 5000 limit";
    ...
    public static String errorInvalidAccountOrAmount = "Invalid account or amount";
